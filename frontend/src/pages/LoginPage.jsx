...
// ❌ DELETED: axios.defaults.withCredentials = true; 
// Why? This causes CORS errors when the backend allows '*'. 
// Your app uses JWT Tokens in headers, so this is NOT needed.
